...
class Sm_Cartpro_Block_Wishlist_Links extends Mage_Wishlist_Block_Links
{
    /**
    ...
    protected function _createLabel($count)
    {
        ...
        if ($count > 1) {
            return $this->__("<span class='lb'>My Wishlist</span><span class='op'>(</span><span class='nb'>%d</span> <span class='cl'>)</span>", $count);
        } else if ($count == 1) {
            return $this->__("<span class='lb'>My Wishlist</span><span class='op'>(</span><span class='nb'>%d</span><span class='cl'>)</span>", $count);
        } else {
            return $this->__("<span class='lb'>My Wishlist (0)</span>");
        }
    }
