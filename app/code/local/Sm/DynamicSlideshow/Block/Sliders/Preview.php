...
class Sm_DynamicSlideshow_Block_Sliders_Preview extends Mage_Core_Block_Template implements Mage_Widget_Block_Interface
{
            ...
            switch ( $type )
            {
                ...
                case 'video':
                    ...
                    switch ( $videoType )
                    {
                        case 'youtube':
                            if ( !$videoArgs )
                                $videoArgs = 'enablejsapi=1&amp;html5=1&amp;hd=1&amp;wmode=opaque&amp;controls=1&amp;showinfo=0;rel=0;';
